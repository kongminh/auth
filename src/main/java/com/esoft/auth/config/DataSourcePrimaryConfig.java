...
@EnableJpaRepositories(
    basePackages = {DataSourcePrimaryConfig.REPOSITORY_PACKAGES},
    entityManagerFactoryRef = DataSourcePrimaryConfig.ENTITY_MANAGER,
    transactionManagerRef = DataSourcePrimaryConfig.TRANSACTION_MANAGER)
public class DataSourcePrimaryConfig {

  public static final String ENTITY_PACKAGES = "com.esoft.auth.entity";
  public static final String REPOSITORY_PACKAGES = "com.esoft.auth.repository";
  ...
  /**
   * @param primaryEntityManager LocalContainerEntityManagerFactoryBean
   * @return
   */
  @Bean
  @Primary
